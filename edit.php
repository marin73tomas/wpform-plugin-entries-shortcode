...
class  Whe_Custom_Edit
{
     ...
     private function hooks()
     {
          ...
          remove_action('wp_ajax_whe_ajax_submit', [wpforms()->process, 'whe_ajax_submit']);
          remove_action('wp_ajax_nopriv_whe_ajax_submit', [wpforms()->process, 'whe_ajax_submit']);
          // Submit action AJAX endpoint.
          add_action('wp_ajax_whe_ajax_submit', [$this, 'whe_ajax_submit']);
          add_action('wp_ajax_nopriv_whe_ajax_submit', [$this, 'whe_ajax_submit']);
          return;
     }
