 ...
 * @since 1.0.0
 */
class Custom_WPForms_Entry_Handler extends Custom_WPForms_DB
{
     ...
     public function get_entries($args = [], $count = false)
     {
           ...
           */
          $args = apply_filters(
               'Custom_wpforms_entry_handler_get_entries_args',
		 ...
		 */
          ...
          $possible_select_values = apply_filters(
               'Custom_wpforms_entry_handler_get_entries_select',
               [
                    'all'       => '*',
		 ...
		 */
           ...
           * @param array $args  Entries query arguments (arguments of the \Custom_WPForms_Entry_Handler::`get_entries( $args )` method).
           */
          $where     = (array) apply_filters('Custom_wpforms_entry_handler_get_entries_where', $where, $args);
      ...
      */
     protected function second_query_where($args)
      ...
      * @return string
      */
     private function second_query_where_arg_value_advanced_search($args, $condition_value)
     { // phpcs:ignore Generic.Metrics.CyclomaticComplexity.TooHigh
