  ...
  (function (document, window, $) {
    var app = {
        ...
        if (typeof $.fn.validate !== "undefined") {
          ...
          $.validator.addMethod(
            ...
            function (value, element) {
              return (
                this.optional(element) ||
                /^(([0-1]?[0-9])|([2][0-3])):([0-5]?[0-9])(\ ?[AP]M)?$/i.test(
                  value
                )
              );
            },
          ...
          $.validator.addMethod(
            ...
            function (params, element) {
              ...
              return wpforms_settings.val_checklimit.replace(
                "{#}",
                choiceLimit
              );
            }
          ...
          $.validator.addMethod(
            ...
            function (value, element) {
              ...
              return (
                this.optional(element) || value.replace(/[^\d]/g, "").length > 0
              );
            },
            wpforms_settings.val_phone
          );
          ...
          $.validator.addMethod(
            ...
            function (value, element) {
              return (
                WPFormsPasswordField.passwordStrength(value, element) >=
                Number($(element).data("password-strength-level"))
              );
            },
          ...
          $(".wpforms-validate").each(function () {
            ...
            if (
              ...
              window["wpforms_" + formID].hasOwnProperty("validate")
            ) {
              ...
              properties = {
                ...
                onfocusout: function (element) {
                  ...
                  if (
                    $(element).hasClass("wpforms-novalidate-onkeyup") &&
                    !element.value
                  ) {
      ...
      isFieldInColumn: function (element) {
        return (
          element.parent().hasClass("wpforms-one-half") ||
      ...
      isDateTimeField: function (element) {
        return (
          element.hasClass("wpforms-timepicker") ||
      ...
      dateTimeErrorPlacement: function (element, error) {
        var $wrapper = element.closest(
          ".wpforms-field-row-block, .wpforms-field-date-time"
        );
        if ($wrapper.length) {
      ...
      loadDatePicker: function () {
        ...
        if (typeof $.fn.flatpickr !== "undefined") {
          $(".wpforms-datepicker-wrap").each(function () {
            ...
            if (
              typeof window["wpforms_" + formID + "_" + fieldID] !==
                "undefined" &&
              window["wpforms_" + formID + "_" + fieldID].hasOwnProperty(
                "datepicker"
              )
            ) {
              properties =
                window["wpforms_" + formID + "_" + fieldID].datepicker;
            } else if (
              typeof window["wpforms_" + formID] !== "undefined" &&
              window["wpforms_" + formID].hasOwnProperty("datepicker")
            ) {
        ...
        if (typeof $.fn.timepicker !== "undefined") {
          $(".wpforms-timepicker").each(function () {
            ...
            if (
              ...
              properties =
                window["wpforms_" + formID + "_" + fieldID].timepicker;
            } else if (
              typeof window["wpforms_" + formID] !== "undefined" &&
      ...
      loadSmartPhoneField: function () {
        ...
        inputOptions.initialCountry =
          wpforms_settings.gdpr && countryCode ? countryCode : "auto";

        $(".wpforms-smart-phone-field").each(function (i, el) {
          var $el = $(el);

          // Hidden input allows to include country code into submitted data.
          inputOptions.hiddenInput = $el
            .closest(".wpforms-field-phone")
            .data("field-id");
          inputOptions.utilsScript =
            wpforms_settings.wpforms_plugin_url +
            "pro/assets/js/vendor/jquery.intl-tel-input-utils.js";
          ...
          $el.on("blur input", function () {
            if (
              $el.intlTelInput("isValidNumber") ||
              !app.empty(window.WPFormsEditEntry)
            ) {
              $el
      ...
      loadPayments: function () {
        ...
        if (typeof $.fn.payment !== "undefined") {
          $(".wpforms-field-credit-card-cardnumber").payment(
            "formatCardNumber"
          );
            ...
            suggested: function ($el, suggestion) {
              if (suggestion.domain.match(/^xn--/)) {
                suggestion.full =
                  suggestion.address +
                  "@" +
                  punycode.toUnicode(suggestion.domain);
              }
              ...
              suggestion =
                ...
                '">' +
                decodeURI(suggestion.full.replace(/%[^a-z0-9]/gi, "%25")) +
                "</a>";
              suggestion = wpforms_settings.val_email_suggestion.replace(
                "{suggestion}",
                suggestion
              );
      ...
      loadChoicesJS: function () {
        ...
        $(
          ...
          args.searchEnabled =
            "undefined" !== typeof searchEnabled ? searchEnabled : true;
          args.callbackOnInit = function () {
            ...
            $element.on("change", function () {
              ...
              if ($element.prop("multiple")) {
                self.getValue(true).length > 0
                  ? $input.addClass(self.config.classNames.input + "--hidden")
                  : $input.removeClass(
                      self.config.classNames.input + "--hidden"
                    );
              }
          ...
          args.callbackOnCreateTemplates = function () {
            ...
            return {
              ...
              option: function (item) {
                ...
                if (
                  "undefined" !== typeof item.placeholder &&
                  true === item.placeholder
                ) {
                ...
                if (
                  $element.hasClass("wpforms-payment-price") &&
                  "undefined" !== typeof item.customProperties &&
                  null !== item.customProperties
                ) {
      ...
      bindUIActions: function () {
        ...
        $(document).on(
          "change",
          ".wpforms-field-rating-item input",
          function () {
            var $this = $(this),
          ...
          function () {
            var $this = $(this),
              ...
              errorMsg =
                ...
                "</div>",
              errorCntTpl =
                '<div class="wpforms-error-container">{errorMsg}</span></div>',
              $submitCnt = $this
                .closest("form.wpforms-form")
        ...
        $(document).on(
          ...
          function (event) {
            var hintEl = $(event.target).siblings(
            ...
            hintEl.html(
              hintEl
                .data("hint")
                .replace("{value}", "<b>" + event.target.value + "</b>")
            );
          }
        );
      ...
      pagebreakNav: function (el) {
        ...
        if ($indicator) {
          ...
          if ("connector" === theme || "circles" === theme) {
            $indicator
              .find(".wpforms-page-indicator-page")
              .removeClass("active");
            $indicator
              .find(".wpforms-page-indicator-page-" + page2)
              .addClass("active");
            $indicator
            ...
            var $pageTitle = $indicator.find(
                ".wpforms-page-indicator-page-title"
              ),
              $pageSep = $indicator.find(
                ".wpforms-page-indicator-page-title-sep"
              ),
              totalPages = $form.find(".wpforms-page").length,
              width = (page2 / totalPages) * 100;
            $indicator
              .find(".wpforms-page-indicator-page-progress")
              .css("width", width + "%");
            $indicator
              .find(".wpforms-page-indicator-steps-current")
              .text(page2);
            if ($pageTitle.data("page-" + page2 + "-title")) {
              $pageTitle
                .css("display", "inline")
                .text($pageTitle.data("page-" + page2 + "-title"));
      ...
      optinMonsterRecaptchaReset: function (optinId) {
        ...
        if ($form.length && $captcha.length) {
          var captchaSiteKey = $captcha.attr("data-sitekey"),
            ...
            apiVar = $captchaContainer.hasClass("wpforms-is-hcaptcha")
              ? hcaptcha
              : grecaptcha;

          $captcha.remove();
          $captchaContainer.prepend(
      ...
      amountSanitize: function (amount) {
        ...
        if (currency.decimal_sep === ",") {
          if (
            ...
            amount.indexOf(currency.thousands_sep) !== -1
          ) {
            amount = amount.replace(
              new RegExp("\\" + currency.thousands_sep, "g"),
              ""
            );
          } else if (
            currency.thousands_sep === "" &&
      ...
      amountFormat: function (amount) {
        ...
        if (
          ...
          amount.indexOf(currency.decimal_sep) !== -1
        ) {
      ...
      setUserIndentifier: function () {
        if (
          ((!window.hasRequiredConsent &&
            typeof wpforms_settings !== "undefined" &&
            wpforms_settings.uuid_cookie) ||
            (window.hasRequiredConsent && window.hasRequiredConsent())) &&
          !app.getCookie("_wpfuuid")
        ) {
      ...
      currentIpToCountry: function (callback) {
        var fallback = function () {
          $.get("https://ipapi.co/jsonp", function () {}, "jsonp").always(
            function (resp) {
      ...
      displayFormAjaxErrors: function ($form, errors) {
        ...
        if (
          app.empty(errors) ||
          (app.empty(errors.general) && app.empty(errors.field))
        ) {
      ...
      displayFormAjaxGeneralErrors: function ($form, errors) {
        ...
        if ("string" === typeof errors) {
          $form
            .find(".wpforms-submit-container")
            .before(
              '<div class="wpforms-error-container">' + errors + "</div>"
            );
          return;
        }
      ...
      formSubmitAjax: function ($form) {
        ...
        args.success = function (json) {
          ...
          if (json.data.confirmation) {
            ...
            $confirmationScroll = $container.find(
