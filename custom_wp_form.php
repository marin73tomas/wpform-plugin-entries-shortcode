...
namespace WPForms {
     ...
     final class Custom_WPForms
     {
          ...
          public function objects()
          {
               ...
               // Global objects.
               $this->form     = new \Custom_WPForms_Form_Handler();
...
namespace {
      ...
      */
     function custom_wpforms()
     {

          return WPForms\Custom_WPForms::instance();
     }
      ...
      * @since 1.5.1
      */
     class_alias('WPForms\Custom_WPForms', 'Custom_WPForms');
}
